...
varname_list = ['lat_conus_max', 'lat_conus_min', 'lon_conus_max', 'lon_conus_min', 'cellsize_400m', 'cellsize_9km',
                'lat_world_ease_9km', 'lon_world_ease_9km', 'lat_conus_ease_9km', 'lon_conus_ease_9km',
                'lat_conus_ease_400m', 'lon_conus_ease_400m', 'lat_conus_ease_12_5km', 'lon_conus_ease_12_5km',
...
fig = plt.figure(figsize=(11, 6), dpi=100, facecolor='w', edgecolor='k')
for ipt in range(2):
    # 400 m
    ax = fig.add_subplot(2, 2, ipt*2+1, projection=ccrs.PlateCarree())
    ax.add_feature(shape_conus)
    ax.set_title(title_content[ipt*2], pad=15, fontsize=13, fontweight='bold')
    ...
    # 9 km
    ax = fig.add_subplot(2, 2, ipt*2+2, projection=ccrs.PlateCarree())
    ax.add_feature(shape_conus)
...
smap_9km_mean_all_usp = sub_n_reproj(smap_9km_mean_all, kwargs_9km, window_9km, output_crs, 3)

masked_smap_400m_mean_usp, mask_transform_smap_400m_mean_usp = \
    mask(dataset=smap_400m_mean_all_usp, shapes=crop_shape_usp, crop=True, all_touched=False, pad=True)
...
masked_smap_9km_mean_usp, mask_transform_smap_9km_mean_usp = \
    mask(dataset=smap_9km_mean_all_usp, shapes=crop_shape_usp, crop=True, all_touched=False, pad=True)
...
plt.subplots_adjust(left=0.04, right=0.88, bottom=0.05, top=0.92, hspace=0.25, wspace=0.2)
...
smap_9km_mean_all_ms = sub_n_reproj(smap_9km_mean_all, kwargs_9km, window_9km, output_crs, 3)

masked_smap_400m_mean_ms, mask_transform_smap_400m_mean_ms = \
    mask(dataset=smap_400m_mean_all_ms, shapes=crop_shape_ms, crop=True, all_touched=False)
...
masked_smap_9km_mean_ms, mask_transform_smap_9km_mean_ms = \
    mask(dataset=smap_9km_mean_all_ms, shapes=crop_shape_ms, crop=True, all_touched=False)
...
plt.subplots_adjust(left=0.04, right=0.88, bottom=0.05, top=0.92, hspace=0.25, wspace=0.35)
cbar_ax = fig.add_axes([0.93, 0.2, 0.015, 0.6])
cbar = fig.colorbar(img, cax=cbar_ax, extend='both')
cbar.set_label('$\mathregular{(m^3/m^3)}$', fontsize=9, x=0.95)
cbar.ax.tick_params(labelsize=9)
...
smap_9km_mean_all_uw = sub_n_reproj(smap_9km_mean_all, kwargs_9km, window_9km, output_crs, 3)

masked_smap_400m_mean_uw, mask_transform_smap_400m_mean_uw = \
    mask(dataset=smap_400m_mean_all_uw, shapes=crop_shape_uw, crop=True, all_touched=False)
...
masked_smap_9km_mean_uw, mask_transform_smap_9km_mean_uw = \
    mask(dataset=smap_9km_mean_all_uw, shapes=crop_shape_uw, crop=True, all_touched=False)
...
fig = plt.figure(figsize=(14, 7), dpi=100, facecolor='w', edgecolor='k')
for ipt in range(3):
    # 400 m
    ax = fig.add_subplot(2, 3, ipt+1, projection=ccrs.PlateCarree())
...
smap_9km_mean_all_lr = sub_n_reproj(smap_9km_mean_all, kwargs_9km, window_9km, output_crs, 3)

masked_smap_400m_mean_lr, mask_transform_smap_400m_mean_lr = \
    mask(dataset=smap_400m_mean_all_lr, shapes=crop_shape_lr, crop=True, all_touched=True)
...
masked_smap_9km_mean_lr, mask_transform_smap_9km_mean_lr = \
    mask(dataset=smap_9km_mean_all_lr, shapes=crop_shape_lr, crop=True, all_touched=True)
...
for ipt in range(3):
    ...
    ax.set_title(title_content[ipt*2], pad=15, fontsize=13, fontweight='bold')
    img = ax.imshow(masked_smap_400m_mean_lr[ipt, :, :], origin='upper', vmin=0, vmax=0.4, cmap='Spectral',
               extent=extent_lr)
    gl = ax.gridlines(draw_labels=True, linestyle='--', linewidth=0.5, alpha=0.5, color='black')
    gl.xlocator = mticker.MultipleLocator(base=0.5)
    gl.ylocator = mticker.MultipleLocator(base=0.5)
    ...
    ax.add_feature(feature_shp_lr)
    ax.set_title(title_content[ipt*2+1], pad=15, fontsize=13, fontweight='bold')
    img = ax.imshow(masked_smap_9km_mean_lr[ipt, :, :], origin='upper', vmin=0, vmax=0.4, cmap='Spectral',
               extent=extent_lr)
    gl = ax.gridlines(draw_labels=True, linestyle='--', linewidth=0.5, alpha=0.5, color='black')
    gl.xlocator = mticker.MultipleLocator(base=0.5)
    gl.ylocator = mticker.MultipleLocator(base=0.5)

...
masked_smap_1km_mean_usp, mask_transform_smap_1km_mean_usp = \
    mask(dataset=smap_1km_mean_all_usp, shapes=crop_shape_usp, crop=True, all_touched=False, pad=True)
...
masked_smap_1km_mean_ms, mask_transform_smap_1km_mean_ms = \
    mask(dataset=smap_1km_mean_all_ms, shapes=crop_shape_ms, crop=True, all_touched=False)
...
masked_smap_1km_mean_uw, mask_transform_smap_1km_mean_uw = \
    mask(dataset=smap_1km_mean_all_uw, shapes=crop_shape_uw, crop=True, all_touched=False)
...
masked_smap_1km_mean_lr, mask_transform_smap_1km_mean_lr = \
    mask(dataset=smap_1km_mean_all_lr, shapes=crop_shape_lr, crop=True, all_touched=True)
